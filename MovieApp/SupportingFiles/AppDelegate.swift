...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let nowPlayingNavigationCtrl = storyboard.instantiateViewController(withIdentifier: "moviesNavigationCtrl") as? UINavigationController,
            let nowPlayingVC = nowPlayingNavigationCtrl.topViewController as? MoviesViewController,
            let popularNavigationCtrl = storyboard.instantiateViewController(withIdentifier: "moviesNavigationCtrl") as? UINavigationController,
            let popularVC = popularNavigationCtrl.topViewController as? MoviesViewController  {
            ...
            popularVC.endpoint = "top_rated"
            popularVC.title = "Popular"
            popularNavigationCtrl.tabBarItem.image = #imageLiteral(resourceName: "Star")
            let tabBarCtrl = UITabBarController()
            tabBarCtrl.viewControllers = [nowPlayingNavigationCtrl, popularNavigationCtrl]
